...
# ----------------------
mask_path = 'smart_Parking-main\mask_1920_1080.png'
video_path = 'smart_Parking-main\parking_1920_1080.mp4'
...
if not cap.isOpened():
    raise FileNotFoundError(f"Video file not found or cannot be opened at path: {video_path}")
